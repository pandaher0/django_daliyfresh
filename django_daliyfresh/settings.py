"""
Django settings for django_daliyfresh project.
...
SECRET_KEY = 'j19skd)#6$n2z71)#dwkz0@918qqvx1l173i5r(mzw4xkfvd7='
...
ROOT_URLCONF = 'django_daliyfresh.urls'
...
WSGI_APPLICATION = 'django_daliyfresh.wsgi.application'
